import { consumeMana, getScore, OBJ } from "./mana_system.js";
...
export const SPELLS = [
  {
    ...
    onStart: (player) => {
      ...
      try { entity.triggerEvent("wizardry:set_growth_0"); } catch {}
    ...
    onChannel: (player, ctx) => {
      ...
      const power = getScore(player, OBJ.POWER, 0);
      ctx.growth = Math.min(120, ctx.growth + 1 + power * 0.2);
