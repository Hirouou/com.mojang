...
test('out-of-ammo fire sequence preserves its authoritative result and cannot become a live replay after resupply', () => {
  ...
  assert.deepEqual(authority.receive(command), rejected);
