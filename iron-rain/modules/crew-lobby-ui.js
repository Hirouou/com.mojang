...
function ensureLobbyStyles() {
  ...
  style.textContent = `
    ...
    @media(max-width:720px) and (orientation:landscape){.crew-lobby{padding:max(8px,env(safe-area-inset-top)) max(8px,env(safe-area-inset-right)) max(8px,env(safe-area-inset-bottom)) max(8px,env(safe-area-inset-left))}.crew-lobby-card{width:min(680px,100%);padding:11px}.crew-lobby-card h2{font-size:18px;margin:4px 0}.crew-lobby-card p{margin-bottom:7px}.crew-factions{margin-bottom:7px}.crew-factions button{min-height:44px;padding:5px 9px 5px 12px}.crew-factions button b{font-size:11px;margin-top:2px}.crew-lobby-room input{padding:7px 10px;font-size:13px}.crew-lobby button{min-height:35px;font-size:9px}.crew-lobby-members{margin:6px 0 4px}.crew-lobby-members div{min-height:32px;padding:5px}.crew-lobby-members span{margin-top:2px}}
    @media(max-height:500px) and (orientation:landscape){.crew-lobby{padding:max(5px,env(safe-area-inset-top)) max(7px,env(safe-area-inset-right)) max(5px,env(safe-area-inset-bottom)) max(7px,env(safe-area-inset-left))}.crew-lobby-card{width:min(720px,100%);max-height:100%;padding:7px 10px;overflow-y:auto}.crew-lobby-card>small{font-size:7px;letter-spacing:1.4px}.crew-lobby-card h2{font-size:15px;line-height:1.05;margin:2px 0 3px}.crew-lobby-card p{font-size:8px;line-height:1.22;margin:0 0 4px}.crew-factions{gap:5px;margin-bottom:4px}.crew-factions button{min-height:34px;padding:3px 8px 3px 10px}.crew-factions button b{font-size:9px;margin-top:1px}.crew-factions button small{font-size:6px}.crew-lobby-room{gap:4px}.crew-lobby-room label{font-size:7px;letter-spacing:.7px}.crew-lobby-room input{margin-top:2px;padding:5px 8px;font-size:12px;line-height:1.15}.crew-lobby button{min-height:30px;font-size:8px}.crew-lobby-members{gap:4px;margin:4px 0 3px}.crew-lobby-members div{min-height:25px;padding:3px 5px}.crew-lobby-members b{font-size:8px}.crew-lobby-members span{font-size:6px;margin-top:1px}.crew-lobby-status{padding:4px 6px;font-size:7px;line-height:1.2}.crew-lobby-actions{gap:4px;margin-top:4px}}
