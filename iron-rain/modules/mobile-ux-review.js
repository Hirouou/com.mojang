...
@media (pointer:coarse),(hover:none),(max-width:900px){
  ...
  .strategic-war{font-size:clamp(8px,1.8vw,12px)}.strategic-war header{gap:6px!important;padding:clamp(5px,1.2vw,9px)!important}.strategic-war header>div{min-width:0}.strategic-war header b{font-size:clamp(10px,2.4vw,13px)!important}.strategic-war header small{font-size:clamp(6px,1.5vw,8px)!important;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}.strategic-war header button{font-size:clamp(7px,1.65vw,10px)!important;padding:clamp(5px,1.3vw,8px)!important;min-height:32px!important;max-width:43vw!important}
  .strategic-war-main{grid-template-columns:1fr!important;grid-template-rows:minmax(0,1fr) auto!important}.strategic-war-map{position:relative!important;overflow:auto!important;overscroll-behavior:contain;scrollbar-width:none;-webkit-overflow-scrolling:touch}.strategic-war-map::-webkit-scrollbar{display:none}.strategic-war canvas{max-width:none!important;max-height:none!important;touch-action:none!important}
  .strategic-war-side{max-height:30dvh!important;min-height:92px!important;overflow:auto!important;border-left:0!important;border-top:1px solid #9caa8738!important;padding:clamp(5px,1.3vw,9px)!important}.war-kpis{display:grid!important;grid-template-columns:repeat(4,minmax(0,1fr))!important;gap:4px!important}.war-kpis div{min-width:0!important;padding:clamp(4px,1vw,7px)!important}.war-kpis b{font-size:clamp(10px,2.5vw,14px)!important}.war-kpis small{font-size:clamp(5px,1.2vw,7px)!important;overflow-wrap:anywhere}.war-legend{font-size:clamp(6px,1.4vw,8px)!important;gap:clamp(4px,1.2vw,8px)!important;flex-wrap:wrap!important}
  .strategic-world-location{left:calc(6px + env(safe-area-inset-left))!important;bottom:6px!important;max-width:min(64vw,320px)!important;padding:6px 8px!important}.strategic-world-location b{font-size:clamp(8px,1.9vw,11px)!important}.strategic-world-location small,.strategic-world-location em{font-size:clamp(5px,1.25vw,8px)!important}
  .ir-map-controls{position:absolute;right:calc(7px + env(safe-area-inset-right));top:58px;z-index:140;display:grid;grid-template-columns:repeat(3,clamp(30px,7.5vw,42px));gap:4px}.ir-map-controls button{height:clamp(30px,7.5vw,42px);min-height:0!important;padding:0!important;border:1px solid #9daa8a73;background:#101812ed;color:#e8eadf;font:800 clamp(11px,3vw,17px)/1 ui-monospace,monospace;border-radius:3px;box-shadow:0 3px 12px #0008}.ir-map-hint{position:absolute;right:calc(7px + env(safe-area-inset-right));top:calc(64px + clamp(30px,7.5vw,42px));z-index:139;background:#07100bd9;border:1px solid #8d9a8145;color:#b7c0b3;padding:4px 6px;font:600 clamp(5px,1.2vw,7px)/1.2 system-ui;letter-spacing:.35px;pointer-events:none;max-width:min(46vw,230px);text-align:right}
...
@media (pointer:coarse) and (orientation:landscape),(max-height:520px) and (orientation:landscape){
  ...
  .strategic-war-main{grid-template-rows:minmax(0,1fr) minmax(72px,24dvh)!important}.strategic-war-side{max-height:24dvh!important;min-height:72px!important}.ir-map-hint{display:none}.strategic-world-location{max-width:min(55vw,280px)!important}
}
`;
